...
exports.instantiateResearchUpgrades = void 0;
    ...
    if (_this.onComplete) {
      if (_this.onComplete.unlockResearchUpgrade) {
        _this.onComplete.unlockResearchUpgrade.forEach(function (upgrade) {
          unlockResearchUpgrade(upgrade, _this.codeName);
        });
      }
    }
  };
...
var unlockResearchUpgrade = function unlockResearchUpgrade(targetUpgrade, previousUpgrade) {
  var upgrade = State_1.InstanceState.researchUpgrades.find(function (upgrade) {
...
var researchUpgrades = [{
  ...
  isLocked: false,
  onComplete: {
    unlockResearchUpgrade: ['researchPowerUp']
  }
}, {
  name: 'Quest Board',
...
function instantiateResearchUpgrades(u) {
  if (u === void 0) {
    u = JSON.parse(localStorage.getItem('researchUpgrades')) || researchUpgrades;
  }

  var builtResearchUpgrades = [];
  u.forEach(function (upgrade) {
    builtResearchUpgrades.push(new ResearchUpgrade(upgrade));
  });
  State_1.InstanceState.researchUpgrades = builtResearchUpgrades;
}

exports.instantiateResearchUpgrades = instantiateResearchUpgrades;
...
exports.completeResearchUpgrade = function (codeName) {
  State_1.InstanceState.researchUpgrades.forEach(function (upgrade) {
...
var updateTabs = function updateTabs() {
  ...
  State_1.InstanceState.tabs.filter(function (tab) {
    ...
    if (tab.codeName === 'research' && State_1.State.research.inProgress) {
