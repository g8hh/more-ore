...
},{"./utils":"scripts/utils.ts","./index":"scripts/index.ts","./State":"scripts/State.ts","./Updates":"scripts/Updates.ts","./Tooltip":"scripts/Tooltip.ts","./RisingText":"scripts/RisingText.ts","./Sounds":"scripts/Sounds.ts"}],"scripts/SmithUpgrades.ts":[function(require,module,exports) {
"use strict";
...
var handleBrokenOre = function handleBrokenOre() {
  ...
  if (State_1.State.stats.rocksDestroyed === 3) unlockTab('smith');
};
...
var updateSmithProgress = function updateSmithProgress() {
  ...
  var oreNeeded = powerPerTick * State_1.State.smith.powerToOreRatio;
...
var updateSmithPower = function updateSmithPower(power) {
  var smithPowerEl = utils_1.select('.smith-power span');
  State_1.State.smith.power = power;
  smithPowerEl.innerHTML = power;
  var smithOreUsageEl = utils_1.select('.smith-ore-usage strong');
  smithOreUsageEl.innerHTML = State_1.State.smith.power * State_1.State.smith.powerToOreRatio;
}; // - -----------------------------------------------------------------------------------
// - TAB BUILD STUFF -------------------------------------------------------------------
// - -----------------------------------------------------------------------------------
...
var buildSmithSettings = function buildSmithSettings() {
  ...
  var oreUsageEl = utils_1.createEl('p', ['smith-ore-usage'], "Using <strong>" + State_1.State.smith.power * State_1.State.smith.powerToOreRatio + "</strong> ores per second while researching.");
